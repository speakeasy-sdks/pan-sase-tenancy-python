...
class TenantServiceGroupCreateVertical(str, Enum):
...
class TenantServiceGroupCreate:
    ...
    """
    vertical: Optional[TenantServiceGroupCreateVertical] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vertical'), 'exclude': lambda f: f is None }})
    r"""A token that identifies the business vertical supported by the SASE
    products managed by this TSG.
    """
